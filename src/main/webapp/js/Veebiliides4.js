    ...
    */
	loadJSON(function(response) {
	  // Parse JSON string into object
		...
		document.getElementById("tablePlanned Data").childNodes[0].childNodes[0].childNodes[3].innerHTML = "Kaitsmise kraad";
		document.getElementById("tablePlanned Data").childNodes[0].childNodes[0].childNodes[4].innerHTML = "Kaitsmise pealkiri";
		document.getElementById("tablePlanned Data").childNodes[0].childNodes[0].childNodes[5].innerHTML = "Kaitsmise autor";
		document.getElementById("tablePlanned Data").childNodes[0].childNodes[0].childNodes[6].innerHTML = "Kaitsmise juhendajad";
		document.getElementById("tablePlanned Data").childNodes[0].childNodes[0].childNodes[7].innerHTML = "Kaitsmise komisjoni liikmed";
		document.getElementById("tablePlanned Data").childNodes[0].childNodes[0].childNodes[8].innerHTML = "Teema";
		document.getElementById("tablePlanned Data").childNodes[0].childNodes[0].childNodes[9].innerHTML = "Ruumi number";
		document.getElementById("tablePlanned Data").childNodes[0].childNodes[0].childNodes[10].innerHTML = "Autori kommentaarid";
		document.getElementById("tablePlanned Data").childNodes[0].childNodes[0].childNodes[11].innerHTML = "Juhendaja kommentaarid";
		document.getElementById("tablePlanned Data").childNodes[0].childNodes[0].childNodes[12].innerHTML = "Komisjoni kommentaarid";
		document.getElementById("tablePlanned Data").childNodes[0].childNodes[0].childNodes[13].innerHTML = "Kommentaarid unikaalsus";
		...
		for(let i = 0; i < tableLength; i++){
			...
			document.getElementById("tablePlanned Data").childNodes[0].childNodes[i+1].childNodes[3].innerHTML = JSON_Data.defenseDegreeList[i]["defense degree"];
			document.getElementById("tablePlanned Data").childNodes[0].childNodes[i+1].childNodes[4].innerHTML = JSON_Data.defenseTitleList[i]["defense title"];
			document.getElementById("tablePlanned Data").childNodes[0].childNodes[i+1].childNodes[5].innerHTML = JSON_Data.defenseAuthorList[i]["defense author"];
			document.getElementById("tablePlanned Data").childNodes[0].childNodes[i+1].childNodes[6].innerHTML = JSON_Data.defenseAuthorsSupervisorsList[i]["defense authors supervisors"];
			document.getElementById("tablePlanned Data").childNodes[0].childNodes[i+1].childNodes[7].innerHTML = JSON_Data.defenseCommiteeList[i]["defense commitee members"];
			document.getElementById("tablePlanned Data").childNodes[0].childNodes[i+1].childNodes[8].innerHTML = JSON_Data.defenseSimilarThemeList[i]["defense similar theme"];
			document.getElementById("tablePlanned Data").childNodes[0].childNodes[i+1].childNodes[9].innerHTML = JSON_Data.defenseRoomNumberList[i]["defense room number"];
			document.getElementById("tablePlanned Data").childNodes[0].childNodes[i+1].childNodes[10].innerHTML = JSON_Data.defenseCommentsAuthorList[i]["defense comments author"];
